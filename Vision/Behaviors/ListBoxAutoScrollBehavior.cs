...
namespace Vision.Behaviors
{
    public class ListBoxAutoScrollBehavior : Behavior<ListBox>
    {
        ...
        public bool IsAutoScroll { get => (bool)GetValue(IsAutoSrollProperty);
        ...
        public static readonly DependencyProperty IsAutoSrollProperty =
            DependencyProperty.Register(nameof(IsAutoScroll), typeof(bool), typeof(ListBoxAutoScrollBehavior), new FrameworkPropertyMetadata(false,OnIsAutoScrollChanged));

        private static void OnIsAutoScrollChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((ListBoxAutoScrollBehavior)d).Subscribe();
        }
